...
class GenericSetupTest(unittest.TestCase):
    ...
    def test_forbidden_registry_record(self):
        ...
        self.assertIsNone(
            api.portal.get_registry_record(interface=IStopWords, name=record)
        )
    ...
    def test_controlpanel_view(self):
        ...
        view = getMultiAdapter((self.portal, self.request), name="stop-words-settings")
    ...
    def test_controlpanel_registered(self):
        ...
        actions_ids = [configlet.id for configlet in control_panel_tool.listActions()]
        self.assertIn("collective.contentalerts.settings", actions_ids)
